              ...
              if (n.globals.dataChanged && "circle" === f.shape)
                if (this.dynamicAnim) {
                  ...
                  for (var M = 0; M < n.globals.collapsedSeries.length; M++)
                    n.globals.collapsedSeries[M].index === s &&
                      ((T = 1), (a = 0));
                  0 === t && 0 === e && (a = 0),
                    h.animateCircle(
                      v,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (c.enabled && !v) {
                ...
                var m = "";
                void 0 !== a &&
                  (m = p(a, { seriesIndex: s, dataPointIndex: r, w: d }));
        ...
        a(s, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              for (
                var v = p ? t.series.length - 1 : 0;
                p ? v >= 0 : v < t.series.length;
                p ? v-- : v++
              ) {
                var m = i.group({
                ...
                e.globals.dataChanged &&
                  ...
                  (C =
                    Math.round(
                      (this.totalAngle *
                        f.negToZero(e.globals.previousPaths[v])) /
                        100
                    ) + k)),
